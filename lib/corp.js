...
Corp.prototype.locations = function(characterId, itemIds,callback) {
...
Corp.prototype.marketOrders = function(characterId, orderId, callback) {
    var params = "&characterID=" + characterId;
    if(orderId) {
...
var walletParams = function(characterId, accountKey, fromId, rowCount, callback) {
    /**
